...
FOOBAR_CHECK_HAVE_INCLUDE(HAVE_FEATURES_H features.h)

# Check for headers
FOOBAR_CHECK_HAVE_INCLUDE(HAVE_ERRNO_H errno.h)
FOOBAR_CHECK_HAVE_INCLUDE(HAVE_LANGINFO_H langinfo.h)
FOOBAR_CHECK_HAVE_INCLUDE(HAVE_MMAP sys/mman.h)
FOOBAR_CHECK_HAVE_INCLUDE(HAVE_PTHREAD_NP_H pthread_np.h)
FOOBAR_CHECK_HAVE_INCLUDE(HAVE_SYS_PARAM_H sys/param.h)
FOOBAR_CHECK_HAVE_INCLUDE(HAVE_SYS_TIME_H sys/time.h)
FOOBAR_CHECK_HAVE_INCLUDE(HAVE_SYS_TIMEB_H sys/timeb.h)
FOOBAR_CHECK_HAVE_INCLUDE(HAVE_LINUX_MEMFD_H linux/memfd.h)
FOOBAR_CHECK_HAVE_INCLUDE(HAVE_SYSLOG_H syslog.h)

# Check for functions
FOOBAR_CHECK_HAVE_FUNCTION(HAVE_ALIGNED_MALLOC _aligned_malloc)
FOOBAR_CHECK_HAVE_FUNCTION(HAVE_ISDEBUGGERPRESENT IsDebuggerPresent)
FOOBAR_CHECK_HAVE_FUNCTION(HAVE_LOCALTIME_R localtime_r)
FOOBAR_CHECK_HAVE_FUNCTION(HAVE_MALLOC_TRIM malloc_trim)
FOOBAR_CHECK_HAVE_FUNCTION(HAVE_STRNSTR strnstr)
FOOBAR_CHECK_HAVE_FUNCTION(HAVE_TIMEGM timegm)
FOOBAR_CHECK_HAVE_FUNCTION(HAVE_VASPRINTF vasprintf)
FOOBAR_CHECK_HAVE_FUNCTION(HAVE_VSYSLOG vsyslog)
FOOBAR_CHECK_HAVE_FUNCTION(HAVE_ALLOCA alloca)

# Check for symbols
FOOBAR_CHECK_HAVE_SYMBOL(HAVE_REGEX_H regexec regex.h)
if (NOT (${CMAKE_SYSTEM_NAME} STREQUAL "Darwin"))
FOOBAR_CHECK_HAVE_SYMBOL(HAVE_PTHREAD_MAIN_NP pthread_main_np pthread_np.h)
endif ()
# Windows has signal.h but is missing symbols that are used in calls to signal.
FOOBAR_CHECK_HAVE_SYMBOL(HAVE_SIGNAL_H SIGTRAP signal.h)

# Check for struct members
FOOBAR_CHECK_HAVE_STRUCT(HAVE_STAT_BIRTHTIME "struct stat" st_birthtime sys/stat.h)
FOOBAR_CHECK_HAVE_STRUCT(HAVE_TM_GMTOFF "struct tm" tm_gmtoff time.h)
FOOBAR_CHECK_HAVE_STRUCT(HAVE_TM_ZONE "struct tm" tm_zone time.h)
