...
- 开发者是基础软件的第一用户
   ...
   1. 我们看到微软、苹果、谷歌，都在不遗余力地开发各种编程语言、应用框架和开发工具。
- 未来的应用，要同时支持云端、桌面、智能手机、平板、手表以及未来的 AR/VR 等平台，因此，跨平台的需求越来越强烈。苹果、谷歌、微软，均在为 Universal App 做技术准备。
...
- HVML 程序的输入包括：传统的流、文件、数据库以及人机交互事件。
